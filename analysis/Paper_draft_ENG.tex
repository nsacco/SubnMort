...
\usepackage{hyperref}
\hypersetup{
            pdftitle={A Methodological Approach Comparison of Mortality Estimates for Small Areas: the Pampean Region in Argentina (2009-2011)},
            pdfborder={0 0 0},
            breaklinks=true}
...
{\centering \includegraphics[width=0.7\linewidth]{plots/dptosBsAs} 
